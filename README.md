  ...
  <main id="itinerary" class="tab-content active">
      ...
      <table class="overview-table">
        ...
        <tbody>
          <tr>
            <td><b>Oct 2</b> (Fri)</td>
            <td>Santiago</td>
            <td>Long-haul arrival, hotel check-in / rest</td>
          </tr>
          <tr>
            <td><b>Oct 3</b> (Sat)</td>
            <td>Santiago</td>
            <td>Barrio Lastarria, Santa Lucía, Bellavista night</td>
          </tr>
          <tr>
            <td><b>Oct 4</b> (Sun)</td>
            <td>Atacama</td>
            <td>Flight to Calama, Death Valley, Moon Valley sunset</td>
          </tr>
          <tr>
            <td><b>Oct 5</b> (Mon)</td>
            <td>Atacama</td>
            <td>Baltinache salt pools, Cejar floating, Laguna Chaxa</td>
          </tr>
          <tr>
            <td><b>Oct 6</b> (Tue)</td>
            <td>Atacama</td>
            <td>Miscanti & Miñiques Lagoons, Piedras Rojas</td>
          </tr>
          <tr>
            <td><b>Oct 7</b> (Wed)</td>
            <td>Transit / Santiago</td>
            <td>El Tatio Geysers sunrise, fly back to Santiago</td>
          </tr>
          <tr>
            <td><b>Oct 8</b> (Thu)</td>
            <td>Buenos Aires</td>
            <td>Fly to BA, Recoleta neighborhood stroll</td>
          </tr>
          <tr>
            <td><b>Oct 9</b> (Fri)</td>
            <td>Ushuaia</td>
            <td>Fly to Ushuaia, Beagle Channel waterfront</td>
          </tr>
          <tr>
            <td><b>Oct 10</b> (Sat)</td>
            <td>Ushuaia</td>
            <td>Tierra del Fuego National Park, Isla Martillo Penguins</td>
          </tr>
          <tr>
            <td><b>Oct 11</b> (Sun)</td>
            <td>El Calafate</td>
            <td>Fly to El Calafate, Glaciarium Ice Museum</td>
          </tr>
          <tr>
            <td><b>Oct 12</b> (Mon)</td>
            <td>El Calafate</td>
            <td>Full-day Perito Moreno Glacier mini-trekking</td>
          </tr>
          <tr>
            <td><b>Oct 13</b> (Tue)</td>
            <td>Buenos Aires</td>
            <td>Fly to BA, Recoleta Cemetery, Teatro Colón, Tango Show</td>
          </tr>
          <tr>
            <td><b>Oct 14</b> (Wed)</td>
            <td>Uruguay Day Trip</td>
            <td>Day ferry to Colonia del Sacramento, historic tour</td>
          </tr>
          <tr>
            <td><b>Oct 15</b> (Thu)</td>
            <td>Buenos Aires</td>
            <td>La Boca Caminito, San Telmo, Plaza de Mayo, Café Tortoni</td>
          </tr>
          <tr>
            <td><b>Oct 16</b> (Fri)</td>
            <td>Departure</td>
            <td>Final city sights, souvenir shopping, departure flight</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div id="day-oct2" class="day-card active">
      <div class="day-header">
        <span class="day-date">Oct 2 (Friday)</span>
        <span class="day-dest">Santiago, Chile</span>
      </div>
      <div class="time-block">
        <div class="time-title">All Day / Flight Options</div>
        <div class="time-desc">
          <span>Arrival in Santiago (Long-haul transit). Stay in Santiago if early arrival.</span>
    ...
    <div id="day-oct3" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 3 (Saturday)</span>
        <span class="day-dest">Santiago, Chile</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>Arrive in Santiago and check in to Novotel Santiago Providencia.</span>
      ...
      <div class="time-block">
        ...
        <div class="time-desc">
          <span>Stroll through the cobblestone streets of Barrio Lastarria for lunch, street markets, and outdoor cafés. Optional visit to Santa Lucía Hill, La Moneda Palace, or Plaza de Armas.</span>
      ...
      <div class="time-block">
        ...
        <div class="time-desc">
          <span>Walk across the river to Bellavista (Calle Constitución & Patio Bellavista). Optional San Cristóbal Hill funicular.</span>
    ...
    <div id="day-oct4" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 4 (Sunday)</span>
        <span class="day-dest">San Pedro de Atacama</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>Fly SCL → CJC on LA146 (08:23–10:35) [Preferred]. Pick up rental car at Calama Airport and drive 1.5h to San Pedro. Check in at Nueva Lodge La Estacion.</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Drive 10 mins to Valley of Death (Valle de la Muerte / Marte) to see red dunes & rock formations. Tickets are bought directly in person at the entry kiosk/booth at the access gate. Cost: 6,000CLP. Optional visit to Magic bus or Pukará de Quitor.</span>
      ...
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc">
          <span>Watch sunset at Valle de la Luna (Duna Mayor & Mirador de Kari). Cost: 10,800CLP. <strong>Reserve online via <a href="https://valledelaluna.com" target="_blank">valledelaluna.com</a></strong></span>
    ...
    <div id="day-oct5" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 5 (Monday)</span>
        <span class="day-dest">San Pedro de Atacama</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>Drive to <strong>Lagunas Escondidas de Baltinache</strong> (turquoise salt pools).  Cost: 12,000CLP. <strong>Ticket:</strong> Buy your ticket directly at the control booth / visitor hut at the entrance gate before accessing the site.</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span><strong>Laguna Cejar y Piedra:</strong> Swim/float in warm afternoon light. Cost: 15,000CLP. <strong>Tickets:</strong> <a href="https://lagunacejar.com/en/buy-tickets/?event=laguna-cejar-y-piedra" target="_blank">Reserve online here</a>.<br>
      ...
      <div class="time-block">
        <div class="time-title">Evening Stargazing Tour</div>
        <div class="time-desc">
          <span><strong>Stargazing tour booked via <a href="https://gyg.me/KxWQmjrh" target="_blank">GetYourGuide</a>!</strong><br>
          Pick up: 7:00 PM at Licancabur 10. Duration: 2.5 hours. Cost: HKD 261 per person.<br>
          Free cancellation until Oct 4, 19:00.</span>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Reminder</div>
        <div class="time-desc">
          <span><strong>Log onto <a href="https://socairechile.cl/shop/" target="_blank">socairechile.cl/shop/</a> on October 5 at 6:30 PM local time to purchase your tickets for the next day to Piedras Rojas. Cost: 13,000CLP.</strong></span>
        </div>
      </div>
    ...
    <div id="day-oct6" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 6 (Tuesday)</span>
        <span class="day-dest">San Pedro de Atacama</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>High-altitude day (~4,200m) visiting Miscanti & Miñiques Lagoons. Hydrate well.</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Continue south to <strong>Piedras Rojas</strong> (Aguas Calientes Salt Flat) across Salar de Talar. <strong>Ticket for Tebinquinche Lagoon:</strong> Paid directly at the entrance booth. Cost: 6,000CLP. Stop at Socaire village and Laguna Tebinquiche on return.</span>
      ...
      <div class="time-block">
        <div class="time-title">Reminder</div>
        <div class="time-desc">
          <span><strong>Check in at the <a href="https://maps.google.com/maps?q=Socaire+Community+Office" target="_blank">Socaire Community Office</a> in the small town of Socaire (located along Highway 23, about 1 hour south of San Pedro de Atacama en route to the sites), before visiting Piedras Rojas.</strong></span>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Prep warm thermals, gloves, and hats for tomorrow's early geysers excursion.</span></div>
      </div>
    ...
    <div id="day-oct7" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 7 (Wednesday)</span>
        <span class="day-dest">Transit / Santiago</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>04:30 AM drive to El Tatio Geysers for sunrise. Stop at Machuca Village on return drive.</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Leave El Tatio ~08:30–09:00 AM back to San Pedro. Return rental car at CJC airport and fly CJC → SCL.</span>
          <a class="map-btn" href="https://maps.google.com/?q=El+Loa+Airport+Calama" target="_blank">📍 Airport Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Consider This Tour</div>
        <div class="time-desc">
          <span><strong><a href="https://www.viator.com/en-HK/search/422580P3?mcid=70066" target="_blank">Half Day Tour to Geysers del Tatio</a></strong><br>
          Start time: 04:30 AM. Duration: 6-7 hours. Cost: HKD 392 per person.</span>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Rest in Santiago before tomorrow's Argentina flight.</span></div>
      </div>
    ...
    <div id="day-oct8" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 8 (Thursday)</span>
        <span class="day-dest">Buenos Aires, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc"><span>Fly from Santiago to Buenos Aires (EZE or AEP).</span></div>
      </div>
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Check in at Up Recoleta Hotel; stroll around Recoleta neighborhood and parks.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Up+Recoleta+Hotel+Buenos+Aires" target="_blank">📍 Recoleta Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Dinner at an Argentine steakhouse (Parrilla).</span></div>
      </div>
    ...
    <div id="day-oct9" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 9 (Friday)</span>
        <span class="day-dest">Ushuaia, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc"><span>Fly from Buenos Aires (AEP/EZE) down to Ushuaia. Check in at Alto Andino Hotel.</span></div>
      </div>
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Walk along the Beagle Channel waterfront and explore town.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Beagle+Channel+Ushuaia" target="_blank">📍 Waterfront Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Try local King Crab (Centolla) for dinner.</span></div>
      </div>
    ...
    <div id="day-oct10" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 10 (Saturday)</span>
        <span class="day-dest">Ushuaia, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>Tierra del Fuego National Park excursion via transfer shuttle (remis) or bus.</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span><strong>Primary:</strong> Excursion/boat tour to Isla Martillo with Piratour to walk among penguins.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Isla+Martillo+Ushuaia" target="_blank">📍 Isla Martillo Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Backup Tour Booked (if Piratour full)</div>
        <div class="time-desc">
          <span><strong><a href="https://gyg.me/tiu1sWc6" target="_blank">Ushuaia: Beagle Channel and Penguin Island</a></strong><br>
      ...
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Relax in Ushuaia town center.</span></div>
      </div>
    ...
    <div id="day-oct11" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 11 (Sunday)</span>
        <span class="day-dest">El Calafate, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc"><span>Fly from Ushuaia to El Calafate. Check in at Destino Calafate.</span></div>
      </div>
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Visit Glaciarium Ice Museum. Tickets can be purchased directly at the ticket window upon arrival.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Glaciarium+El+Calafate" target="_blank">📍 Glaciarium Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Dinner in town along Av. del Libertador.</span></div>
      </div>
    ...
    <div id="day-oct12" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 12 (Monday)</span>
        <span class="day-dest">El Calafate, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Consider this Full Day Tour</div>
        <div class="time-desc">
          <span><strong><a href="https://www.getyourguide.com/el-calafate-l544/el-calafate-perito-moreno-glacier-mini-hiking-experience-t233632/?utm_medium=sharing&utm_campaign=activity_details_ios" target="_blank">Perito Moreno Glacier Trekking Tour and Cruise</a></strong><br>
      ...
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Farewell Patagonia dinner in El Calafate.</span></div>
      </div>
    ...
    <div id="day-oct13" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 13 (Tuesday)</span>
        <span class="day-dest">Buenos Aires, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc"><span>Fly from El Calafate to Buenos Aires. Check in at NH Collection Buenos Aires Crillon.</span></div>
      </div>
      <div class="time-block">
        <div class="time-title">Late Morning</div>
        <div class="time-desc">
          <span>Visit Recoleta Cemetery and stroll down Avenida Santa Fe to browse El Ateneo Grand Splendid.</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Take a guided tour at Teatro Colón, then head north to explore Palermo Soho for boutique shopping and cafés.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Teatro+Colon+Buenos+Aires" target="_blank">📍 Teatro Colón Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Attend a live Tango Show with dinner (Gala Tango / El Querandí).</span></div>
      </div>
    ...
    <div id="day-oct14" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 14 (Wednesday)</span>
        <span class="day-dest">Buenos Aires / Uruguay</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>Take morning ferry across Rio de la Plata to Colonia del Sacramento, Uruguay. <strong>Book via <a href="https://www.buquebus.com/int" target="_blank">Buquebus</a></strong> (return trip cost: USD 94.87 per person).</span>
      ...
      <div class="time-block">
        <div class="time-title">Afternoon</div>
        <div class="time-desc">
          <span>Explore historic cobble streets and lighthouse in Colonia del Sacramento.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Colonia+del+Sacramento+Uruguay" target="_blank">📍 Colonia Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Ferry back to Buenos Aires for dinner.</span></div>
      </div>
    ...
    <div id="day-oct15" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 15 (Thursday)</span>
        <span class="day-dest">Buenos Aires, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc">
          <span>Head south via Uber to Caminito in La Boca for colorful tin houses and street tango performers.</span>
      ...
      <div class="time-block">
        ...
        <div class="time-desc">
          <span>Explore antique stalls inside Mercado de San Telmo. Visit Plaza de Mayo to view Casa Rosada, then enjoy coffee and churros at Café Tortoni.</span>
          <a class="map-btn" href="https://maps.google.com/?q=Cafe+Tortoni+Buenos+Aires" target="_blank">📍 Café Tortoni Map</a>
        </div>
      </div>
      <div class="time-block">
        <div class="time-title">Evening</div>
        <div class="time-desc"><span>Final evening celebration dinner in Buenos Aires.</span></div>
      </div>
    ...
    <div id="day-oct16" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 16 (Friday)</span>
        <span class="day-dest">Departure</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
        <div class="time-desc"><span>Check out and final souvenirs/coffee.</span></div>
      </div>
      <div class="time-block">
        <div class="time-title">Afternoon & Evening</div>
        <div class="time-desc"><span>Transfer to EZE airport for departure long-haul flight home. In-flight.</span></div>
      </div>
