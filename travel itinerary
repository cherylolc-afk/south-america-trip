...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tip-item b { color: var(--warm-dark); }
  </style>
</head>
<body>
    ...
    <a href="https://www.meteoblue.com/en/weather/forecast/week/santiago-de-chile_chile_3871336" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          ...
          <div>
            <div class="weather-date">Oct 2</div>
    ...
    <a href="https://www.meteoblue.com/en/weather/forecast/week/santiago-de-chile_chile_3871336" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">☀️</span>
          <div>
            <div class="weather-date">Oct 3</div>
            <div class="weather-city">Santiago, Chile ↗</div>
    ...
    <a href="https://www.accuweather.com/en/cl/san-pedro-de-atacama/106346/weather-forecast/106346" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">🌤️</span>
          <div>
            <div class="weather-date">Oct 4</div>
    ...
    <a href="https://www.accuweather.com/en/cl/san-pedro-de-atacama/106346/weather-forecast/106346" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">☀️</span>
          <div>
            <div class="weather-date">Oct 5</div>
    ...
    <a href="https://www.accuweather.com/en/cl/san-pedro-de-atacama/106346/weather-forecast/106346" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          ...
          <div>
            <div class="weather-date">Oct 6</div>
    ...
    <a href="https://www.accuweather.com/en/cl/san-pedro-de-atacama/106346/weather-forecast/106346" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">❄️</span>
          <div>
            <div class="weather-date">Oct 7</div>
    ...
    <a href="https://www.accuweather.com/en/ar/buenos-aires/7894/weather-forecast/7894" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">⛅</span>
          <div>
            <div class="weather-date">Oct 8</div>
    ...
    <a href="https://www.accuweather.com/en/ar/ushuaia/7180/weather-forecast/7180" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">🌧️</span>
          <div>
            <div class="weather-date">Oct 9</div>
    ...
    <a href="https://www.accuweather.com/en/ar/ushuaia/7180/weather-forecast/7180" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">⛅</span>
          <div>
            <div class="weather-date">Oct 10</div>
    ...
    <a href="https://www.accuweather.com/en/ar/el-calafate/7123/weather-forecast/7123" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">💨</span>
          <div>
            <div class="weather-date">Oct 11</div>
    ...
    <a href="https://www.accuweather.com/en/ar/el-calafate/7123/weather-forecast/7123" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">❄️</span>
          <div>
            <div class="weather-date">Oct 12</div>
    ...
    <a href="https://www.accuweather.com/en/ar/buenos-aires/7894/weather-forecast/7894" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">☀️</span>
          <div>
            <div class="weather-date">Oct 13</div>
            <div class="weather-city">Buenos Aires, Argentina ↗</div>
    ...
    <a href="https://www.accuweather.com/en/uy/colonia-del-sacramento/352467/weather-forecast/352467" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">🌤️</span>
          <div>
            <div class="weather-date">Oct 14</div>
    ...
    <a href="https://www.accuweather.com/en/ar/buenos-aires/7894/weather-forecast/7894" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">☀️</span>
          <div>
            <div class="weather-date">Oct 15</div>
            <div class="weather-city">Buenos Aires, Argentina ↗</div>
    ...
    <a href="https://www.accuweather.com/en/ar/buenos-aires/7894/weather-forecast/7894" target="_blank" class="weather-card-link">
      <div class="weather-card">
        <div class="weather-left">
          <span class="weather-icon">⛅</span>
          <div>
            <div class="weather-date">Oct 16</div>
  ...
  <main id="itinerary" class="tab-content">
    ...
    <div id="day-oct3" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 3</span>
        <span class="day-dest">Santiago, Chile</span>
      </div>
      <div class="time-block">
    ...
    <div id="day-oct4" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 4</span>
    ...
    <div id="day-oct5" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 5</span>
        <span class="day-dest">San Pedro de Atacama</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
    ...
    <div id="day-oct6" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 6</span>
        <span class="day-dest">San Pedro de Atacama</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
    ...
    <div id="day-oct7" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 7</span>
    ...
    <div id="day-oct8" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 8</span>
    ...
    <div id="day-oct9" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 9</span>
    ...
    <div id="day-oct10" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 10</span>
        <span class="day-dest">Ushuaia, Argentina</span>
      </div>
      <div class="time-block">
        <div class="time-title">Morning</div>
    ...
    <div id="day-oct11" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 11</span>
    ...
    <div id="day-oct12" class="day-card">
      <div class="day-header">
        <span class="day-date">Oct 12</span>
        <span class="day-dest">El Calafate, Argentina</span>
      </div>
      <div class="time-block">
  ...
  <main id="flights" class="tab-content">
    <div class="guide-section">
      <div class="guide-title">✈️ Flight Options & Route Schedule</div>
      ...
      <div class="item-card">
        ...
        <div class="flight-option">• Buquebus / Colonia Express (Puerto Madero Terminal)</div>
      </div>

      <div class="item-card">
        <div class="item-card-header">Oct 16: Long-Haul Departure Flight</div>
        <div class="flight-option">• EZE Departure Flights (In-flight to HKG)</div>
      </div>
    </div>
  </main>
  ...
  <main id="hotels" class="tab-content">
    <div class="guide-section">
      ...
      <div class="item-card">
        <div class="item-card-header">DoubleTree by Hilton Santiago Kennedy</div>
      ...
      <div class="item-card">
        <div class="item-card-header">Nueva Lodge La Estacion (San Pedro de Atacama)</div>
      ...
      <div class="item-card">
        <div class="item-card-header">Up Recoleta Hotel (Buenos Aires)</div>
      ...
      <div class="item-card">
        <div class="item-card-header">Alto Andino Hotel (Ushuaia)</div>
      ...
      <div class="item-card">
        <div class="item-card-header">Destino Calafate (El Calafate)</div>
      ...
      <div class="item-card">
        <div class="item-card-header">NH Collection Buenos Aires Crillon</div>
    ...
    <div class="guide-section">
      <div class="guide-title">💡 Essential Local Travel Notes & Tips</div>
